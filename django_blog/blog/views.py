...
class PostListView(ListView):
    ...
    def get_queryset(self):
        ...
        return Post.objects.all().select_related('author').prefetch_related('tags').order_by('-created_at')
...
def search_posts(request):
    ...
    Uses Django Q objects for complex queries with OR logic.
    """
...
class PostByTagListView(ListView):
    ...
    Displays all posts that have the specified tag.
    """
    model = Post
    ...
    def get_queryset(self):
        ...
        # Filter posts by tag and optimize queries
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        # Get the tag object to display in template
        tag_slug = self.kwargs.get('tag_slug')
